...
class CameraFileWidget extends StatefulWidget {
  ...
  const CameraFileWidget({super.key, this.customButton});

  @override
  State<CameraFileWidget> createState() => _CameraFileWidgetState();
}

class _CameraFileWidgetState extends State<CameraFileWidget>
